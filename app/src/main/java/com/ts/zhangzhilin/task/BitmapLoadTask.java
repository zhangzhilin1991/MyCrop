...
//            }
//        } finally {
//            com.yalantis.ucrop.util.BitmapLoadUtils.close(source);
//            com.yalantis.ucrop.util.BitmapLoadUtils.close(sink);
//            if (response != null) {
//                com.yalantis.ucrop.util.BitmapLoadUtils.close(response.body());
//            }
//        }
//
